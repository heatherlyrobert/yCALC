...
const tFUNCS  g_ycalc_funcs [MAX_FUNCS] = {
   /*--BASIC-MATH---*/  /*---func-to-call--------type--terms-----cat----desc-of-terms---------desc-of-function------------------------------------*/
   { "+"          ,  1, ycalc_add               , 'o', "n:nn"   , 'm', "num1 + num2"        , "ansi-c addition"                                   },
   { "-"          ,  1, ycalc_subtract          , 'o', "n:nn"   , 'm', "num1 - num2"        , "ansi-c subtraction"                                },
   { "*"          ,  1, ycalc_multiply          , 'o', "n:nn"   , 'm', "num1 * num2"        , "ansi-c multipication"                              },
   { "´"          ,  1, ycalc_multiply          , 'o', "n:nn"   , 'm', "num1 ´ num2"        , "ansi-c multipication"                              },
   { "/"          ,  1, ycalc_divide            , 'o', "n:nn"   , 'm', "num1 / num2"        , "ansi-c division"                                   },
   { "%"          ,  1, ycalc_modulus           , 'o', "n:nn"   , 'm', "num1 % num2"        , "ansi-c modulus"                                    },
   { "++"         ,  2, ycalc_increment         , 'o', "n:n"    , 'm', "++num"              , "truly x + 1 as base variable uneffected"           },
   { "--"         ,  2, ycalc_decrement         , 'o', "n:n"    , 'm', "--num"              , "truly x - 1 as base variable uneffected"           },
   { ":+"         ,  2, ycalc_increment         , 'o', "n:n"    , 'm', "num++"              , "non-standard, acts like prefix ++"                 },
   { ":-"         ,  2, ycalc_decrement         , 'o', "n:n"    , 'm', "num--"              , "non-standard, acts like prefix --"                 },
   { "-:"         ,  2, ycalc_unaryminus        , 'o', "n:n"    , 'm', "-num"               , "ansi-c unary minus"                                },
   { "+:"         ,  2, ycalc_noop              , 'o', "n:n"    , 'm', "+num"               , "ansi-c unary plus (no effect)"                     },
   /*--POWERS-------*/  /*---func-to-call--------type--terms-----cat----desc-of-terms---------desc-of-function------------------------------------*/
   { "Ë"          ,  1, ycalc_scipos            , 'o', "n:nn"   , 'm', "valËexp"            , "x raised to the power of 10Ê"                      },
   { "Ë-"         ,  2, ycalc_scineg            , 'o', "n:nn"   , 'm', "valË-exp"           , "x raised to the power of 10Ê"                      },
   { "Ë+"         ,  2, ycalc_scipos            , 'o', "n:nn"   , 'm', "valË+exp"           , "x raised to the power of 10Ê"                      },
   { "exp"        ,  3, ycalc_power             , 'f', "n:nn"   , 'm', "(val,pow)"          , "x raised to the power of y"                        },
   { "pow"        ,  3, ycalc_power             , 'f', "n:nn"   , 'm', "(val,pow)"          , "x raised to the power of y"                        },
   { "`"          ,  1, ycalc_power             , 'o', "n:nn"   , 'm', "val`pow"            , "x raised to the power of y"                        },
   { "Æ"          ,  1, ycalc_power_of_2        , 'o', "n:n"    , 'm', "valÆ"               , "x raised to the power of 2"                        },
   { "Ç"          ,  1, ycalc_power_of_3        , 'o', "n:n"    , 'm', "valÇ"               , "x raised to the power of 3"                        },
   { "È"          ,  1, ycalc_power_of_4        , 'o', "n:n"    , 'm', "valÈ"               , "x raised to the power of 4"                        },
   { "É"          ,  1, ycalc_power_of_x        , 'o', "n:n"    , 'm', "valÉ"               , "x raised to the power of var x"                    },
   { "Ê"          ,  1, ycalc_power_of_y        , 'o', "n:n"    , 'm', "valÊ"               , "x raised to the power of var y"                    },
   { "sqr"        ,  3, ycalc_power_of_2        , 'f', "n:n"    , 'm', "(val)"              , "square of x"                                       },
   { "cube"       ,  4, ycalc_power_of_3        , 'f', "n:n"    , 'm', "(val)"              , "cube of x"                                         },
   /*--ROOTS--------*/  /*---func-to-call--------type--terms-----cat----desc-of-terms---------desc-of-function------------------------------------*/
   { "Î"          ,  1, ycalc_sqrt              , 'o', "n:n"    , 'm', "valÎ"               , "ansi-c square root"                                },
   { "sqrt"       ,  4, ycalc_sqrt              , 'f', "n:n"    , 'm', "(val)"              , "ansi-c square root"                                },
   { "cbrt"       ,  4, ycalc_cbrt              , 'f', "n:n"    , 'm', "(val)"              , "cube root of x"                                    },
   /*--MATH-FUNC----*/  /*---func-to-call--------type--terms-----cat----desc-of-terms---------desc-of-function------------------------------------*/
   { "abs"        ,  3, ycalc_abs               , 'f', "n:n"    , 'm', "(val)"              , "ansi-c fabs() removes negative sign"               },
   { "sign"       ,  4, ycalc_sign              , 'f', "n:n"    , 'm', "(val)"              , "neg = -1, pos = +1, zero = 0"                      },
   { "trunc"      ,  5, ycalc_trunc             , 'f', "n:n"    , 'm', "(val)"              , "truncate to the nearest integer value"             },
   { "truncn"     ,  6, ycalc_rtrunc            , 'f', "n:nn"   , 'm', "(val,dec)"          , "truncate to dec decimal places"                    },
   { "round"      ,  5, ycalc_round             , 'f', "n:n"    , 'm', "(val)"              , "round val, up or down, to the nearest integer"     },
   { "roundn"     ,  6, ycalc_rround            , 'f', "n:nn"   , 'm', "(val,dec)"          , "round val, up or down, to dec decimal places"      },
   { "ceil"       ,  4, ycalc_ceiling           , 'f', "n:n"    , 'm', "(val)"              , "raise up to the nearest integer"                   },
   { "floor"      ,  5, ycalc_floor             , 'f', "n:n"    , 'm', "(val)"              , "push down to the nearest integer"                  },
   { "rand"       ,  4, ycalc_rand              , 'f', "n:"     , 'm', "()"                 , "random number between 0.000 and 1.000 (inclusive"  },
   { "randr"      ,  5, ycalc_randr             , 'f', "n:nn"   , 'm', "(min,max)"          , "random number between min and max (inclusive)"     },
   /*--RELATE-NUM---*/  /*---func-to-call--------type--terms-----cat----desc-of-terms---------desc-of-function------------------------------------*/
   { "=="         ,  2, ycalc_equal             , 'o', "b:nn"   , 'l', "num1 == num2"       , "T if x are y are equal, else F"                    },
   { "!="         ,  2, ycalc_notequal          , 'o', "b:nn"   , 'l', "num1 != num2"       , "T if x not equal y, else F"                        },
   { ">"          ,  1, ycalc_greater           , 'o', "b:nn"   , 'l', "num1 > num2"        , "T if x greater than y, else F"                     },
   { "<"          ,  1, ycalc_lesser            , 'o', "b:nn"   , 'l', "num1 < num2"        , "T if x lesser than y, else F"                      },
   { ">="         ,  2, ycalc_gequal            , 'o', "b:nn"   , 'l', "num1 >= num2"       , "T if x greater than or equal to y, else F"         },
   { "<="         ,  2, ycalc_lequal            , 'o', "b:nn"   , 'l', "num1 <= num2"       , "T if x lesser than or equal to y, else F"          },
   { "à"          ,  1, ycalc_equal             , 'o', "b:nn"   , 'l', "num1 à num2"        , "T if x are y are equal, else F"                    },
   { "Þ"          ,  1, ycalc_notequal          , 'o', "b:nn"   , 'l', "num1 Þ num2"        , "T if x not equal y, else F"                        },
   ...
   { "©!"         ,  2, ycalc_snotequal         , 'o', "b:ss"   , 'l', "str1 ©! str2"       , "T if n not equal m, else F"                        },
   { "©<"         ,  2, ycalc_slesser           , 'o', "b:ss"   , 'l', "str1 ©< str2"       , "T if n greater than m, else F"                     },
   { "©>"         ,  2, ycalc_sgreater          , 'o', "b:ss"   , 'l', "str1 ©> str2"       , "T if n lesser than m, else F"                      },
   { "©Ü"         ,  2, ycalc_slequal           , 'o', "b:ss"   , 'l', "str1 ©Ü str2"       , "T if n greater thanor equal  m, else F"            },
   { "©Ý"         ,  2, ycalc_sgequal           , 'o', "b:ss"   , 'l', "str1 ©Ý str2"       , "T if n lesser thanor equal  m, else F"             },
   { "â"          ,  1, ycalc_substr            , 'o', "b:ss"   , 'l', "str â sub"          , "T if n lesser thanor equal  m, else F"             },
   { "strstr"     ,  6, ycalc_substr            , 'f', "b:ss"   , 'l', "(str,sub)"          , "T if n lesser thanor equal  m, else F"             },
   { "ã"          ,  1, ycalc_listitem          , 'o', "b:ss"   , 'l', "list ã item"        , "T if n lesser thanor equal  m, else F"             },
   { "inlist"     ,  6, ycalc_listitem          , 'f', "b:ss"   , 'l', "(list,item)"        , "T if n lesser thanor equal  m, else F"             },
   /*--JOINING------*/  /*---func-to-call--------type--terms-----cat----desc-of-terms---------desc-of-function------------------------------------*/
   { "!"          ,  1, ycalc_not               , 'o', "b:b"    , 'l', "! bool"             , "true if BOOL is zero, else false"                  },
   { "&&"         ,  2, ycalc_and               , 'o', "b:bb"   , 'l', "bool && bool"       , "true if both BOOL are non-zero, else false"        },
   { "||"         ,  2, ycalc_or                , 'o', "b:bb"   , 'l', "bool || bool"       , "true if either BOOL are non-zero, else false"      },
   { "!&"         ,  2, ycalc_nand              , 'o', "b:bb"   , 'l', "bool !& bool"       , "true if either BOOL is zero, else false"           },
   { "!|"         ,  2, ycalc_nor               , 'o', "b:bb"   , 'l', "bool !| bool"       , "true if only one BOOL is non-zero, else false"     },
   { "&|"         ,  2, ycalc_xor               , 'o', "b:bb"   , 'l', "bool &| bool"       , "true if only one BOOL is non-zero, else false"     },
   { "|&"         ,  2, ycalc_nxor              , 'o', "b:bb"   , 'l', "bool |& bool"       , "true if both BOOL are same, else false"            },
   { "not"        ,  3, ycalc_not               , 'f', "b:b"    , 'l', "(bool)"             , "true if BOOL is zero, else false"                  },
   { "and"        ,  3, ycalc_and               , 'f', "b:bb"   , 'l', "(bool,bool)"        , "true if both BOOL are non-zero, else false"        },
   { "or"         ,  2, ycalc_or                , 'f', "b:bb"   , 'l', "(bool,bool)"        , "true if either BOOL are non-zero, else false"      },
   { "nand"       ,  4, ycalc_nand              , 'f', "b:bb"   , 'l', "(bool,bool)"        , "true if either BOOL is zero, else false"           },
   { "nor"        ,  3, ycalc_nor               , 'f', "b:bb"   , 'l', "(bool,bool)"        , "true if only one BOOL is non-zero, else false"     },
   { "xor"        ,  3, ycalc_xor               , 'f', "b:bb"   , 'l', "(bool,bool)"        , "true if only one BOOL is non-zero, else false"     },
   { "nxor"       ,  4, ycalc_nxor              , 'f', "b:bb"   , 'l', "(bool,bool)"        , "true if both BOOL are same, else false"            },
   /*--CONDITIONAL--*/  /*---func-to-call--------type--terms-----cat----desc-of-terms---------desc-of-function------------------------------------*/
   { "if"         ,  2, ycalc_if                , 'f', "n:bnn"  , 'l', "(bool,yes,no)"      , "if check is true, equals yes, else equals no"      },
   { "ifs"        ,  3, ycalc_ifs               , 'f', "s:bss"  , 'l', "(bool,yes,no)"      , "if x is T, n, else m"                              },
   { "ifr"        ,  3, NULL                    , 'f', "s:brr"  , 'l', "(bool,yes,no)"      , "if x is T, n, else m"                              },
   { "ifm"        ,  3, NULL                    , 'f', "s:bmm"  , 'l', "(bool,yes,no)"      , "if x is T, n, else m"                              },
   /*--BITWISE------*/  /*---func-to-call--------type--terms-----cat----desc-of-terms---------desc-of-function------------------------------------*/
   { "~"          ,  1, ycalc_bit_notplus       , 'f', "n:nn"   , 'l', "bin ~ nib"          , "bitwise not on BIN for NIB nibbles"                },
   { "<<"         ,  2, ycalc_bit_left          , 'f', "n:nn"   , 'l', "bin << place"       , "shift BIN bits PLACE places to the left"           },
   { ">>"         ,  2, ycalc_bit_right         , 'f', "n:nn"   , 'l', "bin >> place"       , "shift BIN bits PLACE places to the right"          },
   { "&"          ,  1, ycalc_bit_and           , 'f', "n:nn"   , 'l', "bin1 & bin2"        , "bitwise and between BIN1 and BIN2"                 },
   { "|"          ,  1, ycalc_bit_or            , 'f', "n:nn"   , 'l', "bin1 | bin2"        , "bitwise or between BIN1 and BIN2"                  },
   { "^"          ,  1, ycalc_bit_xor           , 'f', "n:nn"   , 'l', "bin1 ^ bin2"        , "bitwise xor between BIN1 and BIN2"                 },
   /*--STR-OPER-----*/  /*---func-to-call--------type--terms-----cat----desc-of-terms---------desc-of-function------------------------------------*/
   { "©"          ,  1, ycalc_concat            , 'o', "s:ss"   , 's', "str1 © str2"        , "concatinate STR2 to end of STR1"                   },
   { "©+"         ,  2, ycalc_concatspace       , 'o', "s:ss"   , 's', "str1 ©+ str2"       , "concatinate STR2 to end of STR1 (with a space)"    },
   { "©©"         ,  2, ycalc_concatcomma       , 'o', "s:ss"   , 's', "str1 ©© str2"       , "concatinate STR2 to end of STR1 (with a comma)"    },
   { "©-"         ,  2, ycalc_remove            , 'o', "s:ss"   , 's', "str1 ©- str2"       , "remove first STR2 instance from STR1"              },
   { "©*"         ,  2, ycalc_word              , 'o', "s:sn"   , 's', "str ©* num"         , "take NUM word from space delimited STR"            },
   { "©´"         ,  2, ycalc_list              , 'o', "s:sn"   , 's', "str ©* num"         , "take NUM word from comma delimited STR"            },
   { "©/"         ,  2, ycalc_parse             , 'o', "s:sn"   , 's', "str ©* num"         , "take NUM word from field delimited STR"            },
   { "©¬"         ,  2, ycalc_mask              , 'o', "s:ss"   , 's', "str ©¬ chars"       , "mask all requested CHARS within STR"               },
   { "©°"         ,  2, ycalc_redact            , 'o', "s:ss"   , 's', "str ©¬ chars"       , "redact all requested CHARS within STR"             },
   /*---(string functions)----------------*/
   ...
   /*-------*/
   { "asin"       ,  4, ycalc_asin              , 'f', "n:n"    , 't', "(opp / hyp)"        , "arcsine in degrees"                                },
   { "asinr"      ,  5, ycalc_asinr             , 'f', "n:n"    , 't', "(opp / hyp)"        , "arcsine in radians"                                },
   { "asin2"      ,  5, ycalc_asin2             , 'f', "n:nn"   , 't', "(opp, hyp)"         , "arcsine in degrees"                                },
   { "asin2r"     ,  6, ycalc_asin2r            , 'f', "n:nn"   , 't', "(opp, hyp)"         , "arcsine in radians"                                },
   { "acos"       ,  4, ycalc_acos              , 'f', "n:n"    , 't', "(adj / hyp)"        , "arcosine in degrees"                               },
   { "acosr"      ,  5, ycalc_acosr             , 'f', "n:n"    , 't', "(adj / hyp)"        , "arcosine in radians"                               },
   { "acos2"      ,  5, ycalc_acos2             , 'f', "n:nn"   , 't', "(adj, hyp)"         , "arcosine in degrees"                               },
   { "acos2r"     ,  6, ycalc_acos2r            , 'f', "n:nn"   , 't', "(adj, hyp)"         , "arcosine in radians"                               },
   { "atan"       ,  4, ycalc_atan              , 'f', "n:n"    , 't', "(opp / adj)"        , "arctangent in degrees"                             },
   { "atanr"      ,  5, ycalc_atanr             , 'f', "n:n"    , 't', "(opp / adj)"        , "arctangent in radians"                             },
   { "atan2"      ,  5, ycalc_atan2             , 'f', "n:nn"   , 't', "(opp, adj)"         , "arctangent in degrees given sides x and y"         },
   { "atanr2"     ,  6, ycalc_atanr2            , 'f', "n:nn"   , 't', "(opp, adj)"         , "arctangent in radians given sides x and y"         },
   { "acrd2"      ,  5, ycalc_acrd2             , 'f', "n:nn"   , 't', "(len, rad)"         , "arc-chord in degrees given chord len and radius"   },
   ...
   /*---(rel to ref)----*/
   { "r2u"        ,  3, ycalc_ru                , 'f', "r:rv"   , 'a', ""                   , "create a reference relative to current"            },
   { "r2x"        ,  3, ycalc_rx                , 'f', "r:rv"   , 'a', ""                   , "create a reference relative to current"            },
   { "r2y"        ,  3, ycalc_ry                , 'f', "r:rv"   , 'a', ""                   , "create a reference relative to current"            },
   { "r2xy"       ,  4, ycalc_rxy               , 'f', "r:rvv"  , 'a', ""                   , "create a reference relative to current"            },
   { "r2uxy"      ,  5, ycalc_ruxy              , 'f', "r:rvvv" , 'a', ""                   , "create a reference relative to current"            },
   /*---(abs to ref)----*/
   { "a2u"        ,  3, ycalc_au                , 'f', "r:rv"   , 'a', ""                   , "create a reference relative to current"            },
   { "a2x"        ,  3, ycalc_ax                , 'f', "r:rv"   , 'a', ""                   , "create a reference relative to current"            },
   { "a2y"        ,  3, ycalc_ay                , 'f', "r:rv"   , 'a', ""                   , "create a reference relative to current"            },
   { "a2xy"       ,  4, ycalc_axy               , 'f', "r:rvv"  , 'a', ""                   , "create a reference relative to current"            },
   { "a2uxy"      ,  5, ycalc_auxy              , 'f', "r:rvvv" , 'a', ""                   , "create a reference relative to current"            },
   /*---(vertical lookups)----------------*/
